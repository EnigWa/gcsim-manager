...
# File management buttons including Terminate
...
tk.Button(input_frame, text="Duplicate", command=duplicate_file, bg="#4e4e4e", fg="white", width=8).grid(row=5, column=2, padx=5, pady=2)
tk.Button(input_frame, text="Terminate", command=terminate_processes, bg="#4e4e4e", fg="white", width=8).grid(row=5, column=3, padx=5, pady=2)
